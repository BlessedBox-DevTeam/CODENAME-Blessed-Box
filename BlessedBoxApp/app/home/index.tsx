      ...
      <SafeAreaView>
        <View style={[commonStyles.card, commonStyles.gridContainer]}>
          <View style={commonStyles.leftColumn}>
            <Text style={commonStyles.title}>
              OCC<Text style={{ color: colors.red_label }}>2025</Text>{" "}
            </Text>
            <Text style={commonStyles.header}>Yearly Goal</Text>
            <Text style={commonStyles.paragraphBold}>
              Boxes Collected:{" "}
              <Text style={{ color: colors.green }}>6,000</Text>{" "}
            </Text>
        ...
        <View style={[commonStyles.card, { marginTop: 20, rowGap: 16 }]}>
          ...
          <Text style={commonStyles.paragraph}>
            ...
            <Text style={{ color: colors.green }}> 45 </Text>boxes
          </Text>
